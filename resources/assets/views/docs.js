...
(function(){
  ...
  var DOCS = [
    ...
    {href: 'haproxy-setup-hapee.html', title: 'HAPEE setup guide', desc: 'The same steps for HAProxy Enterprise, where the paths are versioned, the API comes from its own package and the service unit already exists.'},
