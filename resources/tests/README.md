...
| `v11-home-run-failure-test.js` | Home raises a warning when an unattended run fails, a preview cannot clear it, and a row badge names its own certificate rather than the zone's |
